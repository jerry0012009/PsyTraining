...
var get_message = function(){
  var fast_rt_message = '<div class = centerbox><p class = block-text>我们检测到您在一些试验中的反应时间异常快。请确保您在大X出现<strong>后</strong>，尽可能快地按<strong>一次</strong>空格键。</p></div>'
	if (flag_curr_trial == 1){
...
var post_task_block = {
   ...
   questions: ['<p class = center-block-text style = "font-size: 20px">请简述您在此任务中被要求做什么。</p>',
              '<p class = center-block-text style = "font-size: 20px">您对此任务有什么意见吗？</p>'],
   rows: [15, 15],
   columns: [60,60]
};
...
var rest_block = {
  ...
  timing_response: 180000,
  text: '<div class = centerbox><p class = block-text>请休息一下！按<strong>回车键</strong>继续任务。</p></div>',
  cont_key: [13],
  timing_post_trial: 0,
  on_finish: function() {
    flag_curr_trial = 0
...
var feedback_instruct_text =
  '欢迎参与实验。本实验大约需要8分钟。按<strong>回车键</strong>开始。'
...
var instructions_block = {
  ...
  pages: [
    '<div class = centerbox><p class = block-text>在这个实验中，我们测试您的反应速度。在每个试验中，请在看到大写的"X"<strong>之后</strong>尽快按下空格键。</p></div>'
  ],
  allow_keys: false,
  ...
  loop_function: function(data) {
    ...
    if (sumInstructTime <= instructTimeThresh * 1000) {
      feedback_instruct_text =
        '您阅读指导语的时间太短。请仔细阅读并确保理解指导语。按<strong>回车键</strong>继续。'
      return true
    } else if (sumInstructTime > instructTimeThresh * 1000) {
      feedback_instruct_text =
        '指导语已完成。按<strong>回车键</strong>继续。'
      return false
    }
  }
}
...
var rest_block = {
  ...
  timing_response: 180000,
  text: '<div class = centerbox><p class = center-block-text>请休息一下！按<strong>回车键</strong>继续。</p></div>',
  cont_key: [13],
  timing_post_trial: 1000
};
...
var start_practice_block = {
  ...
  timing_response: 180000,
  text: '<div class = centerbox><p class = center-block-text>我们将开始5个练习试验。按<strong>回车键</strong>开始。</p></div>',
  cont_key: [13],
  timing_post_trial: 1000
};
...
var start_test_block = {
  ...
  timing_response: 180000,
  text: '<div class = centerbox><p class = block-text>现在开始正式测试。看到"X"时请尽快按空格键反应。测试中将有两次休息。按<strong>回车键</strong>开始。</p></div>',
  cont_key: [13],
  timing_post_trial: 1000,
  on_finish: function() {
    current_trial = 0
