...
Game.Run.prototype = {
  ...
  nextTrial: function () {
    ...
    this.progress = this.game.add.text(860, 560, '第 ' + (this.trial+1) + ' 题，共 ' + this.op1s.length + ' 题', {font:'30px Arial', fill:'#FFFFFF', align:'center'})
  ...
  quitGame: function (pointer) {
      ...
      this.game.time.events.add(Phaser.Timer.SECOND, function () {
        ...
        finalPoints = this.game.add.text(this.game.width/2, 400, '你获得了 ' + this.points + ' 金币', {font:'76px Arial', fill:'#FFFFFF', align:'center'});
