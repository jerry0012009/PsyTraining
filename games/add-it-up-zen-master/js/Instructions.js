...
Game.Instructions.prototype = {
  ...
  instruct: function (num) {
    if (num == 1) {
          instruct_text = this.game.add.text(this.game.world.centerX+60,460,"在这个游戏中，\n你将解决加法问题。",
          ...
          instruct_text = this.game.add.text(this.game.world.centerX+10,460,"当你知道答案时，\n使用数字键盘输入。",
          {font: "20px Arial", fill: "#FFFFFF", align: "center"})
          this.nextB = this.add.button(this.game.world.centerX+175, 530, 'next', function () {
            this.game.world.remove(instruct_text)
            this.rmInstructB = true
          ...
          instruct_text = this.game.add.text(this.game.world.centerX+50,460,"点击"提交"按钮\n提交你的答案。",
          {font: "20px Arial", fill: "#FFFFFF", align: "center"})
          this.nextB = this.add.button(this.game.world.centerX+175, 530, 'next', function () {
            this.game.world.remove(instruct_text)
            this.rmInstructB = true
          ...
          instruct_text = this.game.add.text(this.game.world.centerX-5,460,"每答对一题你将获得一枚金币。\n尽可能多地收集金币！",
          {font: "20px Arial", fill: "#FFFFFF", align: "center"})
          this.nextB = this.add.button(this.game.world.centerX+175, 530, 'next', function () {
            this.game.world.remove(instruct_text)
            this.rmInstructB = true
          ...
          instruct_text = this.game.add.text(this.game.world.centerX+10,460,"但要小心，\n答错会失去一枚金币。",
          {font: "20px Arial", fill: "#FFFFFF", align: "center"})
          this.nextB = this.add.button(this.game.world.centerX+175, 530, 'next', function () {
            this.game.world.remove(instruct_text)
            this.rmInstructB = true
          ...
          instruct_text = this.game.add.text(this.game.world.centerX+30,460,"连续答对\n将获得额外金币！",
          {font: "20px Arial", fill: "#FFFFFF", align: "center"})
          this.nextB = this.add.button(this.game.world.centerX+175, 530, 'next', function () {
            this.game.world.remove(instruct_text)
            this.rmInstructB = true
          ...
          this.instruct_text = this.game.add.text(this.game.world.centerX+20,500,"现在试试这道题吧。",
          {font: "20px Arial", fill: "#FFFFFF", align: "center"})
  ...
  nextTrial: function () {
    ...
    this.progress = this.game.add.text(860, 560, '第 ' + (this.trial+1) + ' 题，共 1 题', {font:'30px Arial', fill:'#FFFFFF', align:'center'})
  ...
  grade: function (time_stamp) {
    ...
    if (this.user_answer == correct_answer) {
      ...
      if (this.streak == 2) {
        this.feedback.text = "连续3个！额外金币！"
        this.feedback.fill = '#3CF948'
        //change color to green...
        this.points+=1
      } else if (this.streak == 6) {
        this.feedback.text = "连续7个！额外金币！"
        this.feedback.fill = '#3CF948'
        this.points+=1
      } else if (this.streak == 14) {
        this.feedback.text = "连续15个！额外金币！"
        this.feedback.fill = '#3CF948'
        this.points+=1
        ...
        correct_feedback = ['太棒了！','真厉害！','你真行！','正确！','非常好！','不错！']
  ...
  quitGame: function (pointer) {
      ...
      this.game.time.events.add(Phaser.Timer.SECOND, function () {
        instructions = this.game.add.text(490, 50, '干得好！理解了吗？如果理解了，点击"开始"按钮开始游戏。\n如果没有，点击"返回"按钮重新查看说明。\n主游戏中你将完成24道题。', {font:'20px Arial', fill:'#FFFFFF', align:'center'});
