...
Game.Run.prototype = {
    ...
    create: function() {
      ...
      this.progress = this.game.add.text(860, 560, '第1题 / 共' + this.op1s.length + '题', {font:'30px Arial', fill:'#FFFFFF', align:'center'})
    ...
    nextTrial: function () {
      ...
      this.trial++;
      this.progress.setText('第' + this.trial + '题 / 共' + this.op1s.length + '题')
    },
    ...
    quitGame: function () {
        ...
        this.game.time.events.add(Phaser.Timer.SECOND * 1.5, function () {
          endText = this.game.add.text(480, 200, '全部完成！', {'font': '70px Arial', 'fill':'#fff'});
          endText.anchor.x = 0.5
          finalPoints = this.game.add.text(this.game.width/2, 75, '你得到了 ' + this.points + ' 分', {font:'70px Arial', fill:'#FFFFFF', align:'center'});
