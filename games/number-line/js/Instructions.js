...
Game.Instructions.prototype = {
    ...
    create: function() {
      ...
      this.progress = this.game.add.text(860, 560, '第1题 / 共1题', {font:'30px Arial', fill:'#FFFFFF', align:'center'})
    ...
    instruct: function(num) {
      if (num == 1) {
        instruct_text = this.game.add.text(670,180,"在这个游戏中，你需要帮助你的角色找到一个\n隐藏在数轴下面的金币。\n尽量找到更多的金币！",
        ...
        instruct_text = this.game.add.text(670,180,"金币的位置是解决这个问题的数字位置。",
        {font: "20px Arial", fill: "#FFFFFF", align: "center"})
        instruct_text.anchor.x = (0.5,0.5)
        this.nextB = this.add.button(670, 280, 'next', function () {
          this.game.world.remove(instruct_text)
        ...
        instruct_text = this.game.add.text(670,180,"当你认为你知道答案时，拖动蓝球\n到那个数字的位置。\n你的角色会跟随！",
        {font: "20px Arial", fill: "#FFFFFF", align: "center"})
        instruct_text.anchor.x = (0.5,0.5)
        this.nextB = this.add.button(670,280, 'next', function () {
          this.game.world.remove(instruct_text)
        ...
        this.instruct_text = this.game.add.text(670,220,"现在你可以尝试回答这个问题了。",
        {font: "20px Arial", fill: "#FFFFFF", align: "center"})
    ...
    nextTrial: function () {
      ...
      this.trial++;
      this.progress.setText('第' + this.trial + '题 / 共1题')
    },
    ...
    endTrial: function() {
      if (this.reps == 3000) {
        this.reps = 0
        this.sorryText = this.game.add.text(200, 400, '很遗憾，正确答案是 ' + this.problem[2], {font: "40px Arial", fill: "#FFFFFF", align: "center"})
        that = this
        setTimeout(function() {
    ...
    quitGame: function () {
        ...
        this.game.time.events.add(Phaser.Timer.SECOND, function () {
          ...
          instructions = this.game.add.text(490, 50, '做得好！明白了吗？如果明白了，可以点击"开始"按钮开始游戏。\n如果还不明白，可以点击"返回"按钮重复查看指令。\n在正式游戏中你将完成13道题目。', {font:'20px Arial', fill:'#FFFFFF', align:'center'});
