...
var feedback_instruct_text =
  '欢迎参加实验。此实验大约需要8分钟。按 <strong>回车键</strong> 开始。'
...
var instructions_block = {
  ...
  pages: [
    '<div class = centerbox><p class = block-text>在本实验的每次试验中，会出现红色或蓝色方框。如果您看到<font color="red">红色</font>方框，请按 ' +
    correct_responses[0][0] + ' 键。如果您看到<font color="blue">蓝色</font>方框，请按 ' + correct_responses[1][0] + ' 键。</p><p class = block-text>我们将从练习开始，您将收到关于是否回应正确的反馈。在您结束指导说明后，我们将开始。</p></div>',
  ],
  allow_keys: false,
  ...
  loop_function: function(data) {
    ...
    if (sumInstructTime <= instructTimeThresh * 1000) {
      feedback_instruct_text =
        '阅读指导说明过快。请花些时间确保您理解指导说明。按 <strong>回车键</strong> 继续。'
      return true
...
var start_test_block = {
  ...
  text: '<div class = centerbox><p class = center-block-text>开始测试。您在回应后将不再收到反馈。请记住，如果您看到<font color="red">红色</font>方框，请按 ' + correct_responses[0][0] + ' 键。如果您看到<font color="blue">蓝色</font>方框，请按 ' + correct_responses[1][0] + ' 键。</p><p class = center-block-text>按 <strong>回车键</strong> 开始。</p></div>',
  cont_key: [13],
  timing_post_trial: 1000,
  on_finish: function() {
    current_trial = 0
...
var practice_block = {
  ...
  timeout_message: '<div class = centerbox><div class = center-text>请回应更快！</div></div>',
  choices: choices,
