...
var feedback_instruct_text =
  '欢迎参加实验。此实验将持续约15分钟。按<strong>回车键</strong>开始。'
...
var instructions_block = {
  ...
  pages: [
    '<div class = centerbox><p class = block-text>在此任务中，每次试验您都会看到一组蓝色圆圈短暂呈现，随后呈现一组黑色圆圈。例如，您可能会看到：</p><br><p class = center-block-text><img src = "images/cue2.png" ></img>&nbsp&nbsp&nbsp...接着是...&nbsp&nbsp&nbsp<img src = "images/probe2.png" ></img></p></div>',
    '<div class = centerbox><p class = block-text>您的任务是在<strong>第二组</strong>圆圈呈现时按下箭头键作出反应。有一对圆圈是<strong>目标</strong>对，对于这一对您应该按<strong>左</strong>箭头键。对于任何其他圆圈对，您应该按<strong>下</strong>箭头键。</p><p class = block-text>作出反应后，您将收到关于您是否正确的反馈。目标对如下所示：</p><br><p class = center-block-text><img src = "images/' +
    valid_cue +
    '" ></img>&nbsp&nbsp&nbsp...接着是...&nbsp&nbsp&nbsp<img src = "images/' +
    valid_probe + '" ></img><br></br></p></div>',
    '<div class = centerbox><p class = block-text>我们现在将开始实验。记住，只有在看到目标对后才按左箭头键。目标对如下所示（最后一次）。请记住它！</p><p class = block-text>请尽可能快速准确地作答。结束指导后您将开始练习。</p><br><p class = center-block-text><img src = "images/' +
    valid_cue +
    '" ></img>&nbsp&nbsp&nbsp...接着是...&nbsp&nbsp&nbsp<img src = "images/' +
  ...
  loop_function: function(data) {
    ...
    if (sumInstructTime <= instructTimeThresh * 1000) {
      feedback_instruct_text =
        '阅读指导太快了。请花时间确保您理解指导内容。按<strong>回车键</strong>继续。'
      return true
...
var rest_block = {
  ...
  timing_response: 180000,
  text: '<div class = centerbox><p class = block-text>休息一下！按任意键继续。</p></div>',
  timing_post_trial: 1000
};
...
var start_test_block = {
  ...
  timing_response: 180000,
  text: '<div class = centerbox><p class = center-block-text>练习结束。我们现在将开始测试。</p><p class = center-block-text>按<strong>回车键</strong>继续。</p></div>',
  cont_key: [13],
  timing_post_trial: 0,
  on_finish: function() {
  	current_trial = 0
