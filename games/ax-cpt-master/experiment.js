...
var post_task_block = {
   ...
   questions: ['<p class = center-block-text style = "font-size: 20px">请简述一下您在这个任务中需要做什么。</p>',
...
var end_block = {
  ...
  text: '<div class = centerbox><p class = center-block-text>感谢您完成了这个任务！</p><p class = center-block-text>按 <strong>Enter</strong> 键继续。</p></div>',
  cont_key: [13],
  timing_post_trial: 0
};
...
var instructions_block = {
  ...
  pages: [
    '<div class = centerbox><p class = block-text>在这个任务中，每个试次您都会看到一个字母短时间呈现，接着出现另一个字母。例如，您可能会看到“A”，然后它会消失并被“F”替代。</p><p class = block-text>您的任务是在<strong>第二个</strong>字母显示期间按下相应的按键。如果第一个字母是“A”<strong>且</strong>第二个字母是“X”，请按 ' +
    possible_responses[0][0] + '。否则请按 ' + possible_responses[1][0] +
    '。</p></div>',
    '<div class = centerbox><p class = block-text>现在我们将开始实验。记住，在看到“A”后接着“X”时按左箭头键，其他所有组合都按下箭头键。</p></div>'
  ],
  allow_keys: false,
  data: {
    exp_id: "ax_cpt",
  ...
  loop_function: function(data) {
    ...
    if (sumInstructTime <= instructTimeThresh * 1000) {
      feedback_instruct_text =
        '阅读指导过于快速。请仔细阅读并确保您理解了指导内容。按 <strong>Enter</strong> 键继续。'
      return true
    } else if (sumInstructTime > instructTimeThresh * 1000) {
      feedback_instruct_text =
        '已完成指导阅读。按 <strong>Enter</strong> 键继续。'
      return false
    }
  }
}
...
var wait_block = {
  ...
  stimulus: '<div class = centerbox><div class = AX_feedback>本试次结束，请准备下一试次。</div></div>',
  is_html: true,
  choices: 'none',
  data: {
    trial_id: "wait"
