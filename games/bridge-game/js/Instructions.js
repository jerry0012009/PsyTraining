...
Game.Instructions.prototype = {
  ...
  instruct: function(num) {
    if (num == 1) {
      ...
      instruct_text = that.game.add.text(this.game.world.centerX,250,"你在游戏中的任务是搭建一座桥，让你的角色能安全过桥 \n并获得另一边的金币。",
      ...
      instruct_text = that.game.add.text(this.game.world.centerX,275,"桥的长度需要等于上面的数字。",
      {font: "20px Arial", fill: "#FFFFFF", align: "center"})
      instruct_text.anchor.x = (0.5,0.5)
      this.nextB = this.add.button(this.game.world.centerX, 320, 'next', function () {
        this.game.world.remove(instruct_text)
      ...
      instruct_text = that.game.add.text(this.game.world.centerX,275,"你不能移动桥的左侧。",
      {font: "20px Arial", fill: "#FFFFFF", align: "center"})
      instruct_text.anchor.x = (0.5,0.5)
      this.nextB = this.add.button(this.game.world.centerX, 320, 'next', function () {
        this.game.world.remove(instruct_text)
      ...
      instruct_text = that.game.add.text(this.game.world.centerX,275,"但你可以在右侧向上拖动木块来完成桥。",
      {font: "20px Arial", fill: "#FFFFFF", align: "center"})
      instruct_text.anchor.x = (0.5,0.5)
      this.nextB = this.add.button(this.game.world.centerX, 320, 'next', function () {
        this.game.world.remove(instruct_text)
      ...
      instruct_text = that.game.add.text(this.game.world.centerX,250,"如果你的桥太长，两侧会碰撞，你需要重新尝试。\n如果你的桥太短，你的角色会掉进缝隙！",
      {font: "20px Arial", fill: "#FFFFFF", align: "center"})
      instruct_text.anchor.x = (0.5,0.5)
      this.nextB = this.add.button(this.game.world.centerX, 320, 'next', function () {
        this.game.world.remove(instruct_text)
      ...
      this.instruct_text = that.game.add.text(this.game.world.centerX,260,"现在就去搭建一座正确长度的桥 \n准备好后点击叉号按钮。",
      {font: "20px Arial", fill: "#FFFFFF", align: "center"})
  ...
  endTrial: function() {
      ...
      if ((this.trial) >= this.op1s.length && this.correct == true) {
        ...
        if (this.correct == true) {
          ...
          if (this.reps == 3000) {
            ...
            if (this.userBridge.length < this.problem[1]) {
              ...
              this.sryText = this.game.add.text(xAdd-200, 25,'抱歉，答案是', {font: "70px Arial", fill: "#FFFFFF", align: "center"})
              ...
              this.sryText = this.game.add.text(this.game.camera.width/2-200, 25,'抱歉，答案是', {font: "70px Arial", fill: "#FFFFFF", align: "center"})
        ...
        this.pointDisplay.setText("金币： " + this.points)
  ...
  quitGame: function () {
      ...
      this.game.time.events.add(Phaser.Timer.SECOND, function () {
        instructions = this.game.add.text(490, 150, '做得好！明白了吗？如果明白了，可以点击“开始”按钮开始游戏。\n如果不明白，可以点击“返回”按钮重新查看指导\n你将在正式游戏中完成 12 道题目。', {font:'20px Arial', fill:'#FFFFFF', align:'center'});
