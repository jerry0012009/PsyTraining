...
Game.Run.prototype = {
  ...
  create: function () {
    ...
    this.progress = this.game.add.text(860, 560, '第 1 题 共 12 题', {font:'30px Arial', fill:'#FFFFFF', align:'center'})
    ...
    this.cross.onInputUp.add(function() {
      if (this.compBridge.length == this.problem[0]) {
  ...
  nextTrial: function () {
    ...
    this.trial++;
    this.progress.setText('第 ' + this.trial + ' 题 共 12 题')
  ...
  quitGame: function () {
      ...
      this.game.time.events.add(Phaser.Timer.SECOND, function () {
        endText = this.game.add.text(this.dude.x+400, 100, '全部完成！', {'font': '70px Arial', 'fill':'#fff'});
        endText.anchor.x = 0.5
        finalPoints = this.game.add.text(this.dude.x+400, 200, '你得到了 ' + this.points + ' 分', {font:'70px Arial', fill:'#FFFFFF', align:'center'});
