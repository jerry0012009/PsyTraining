...
var getTestFeedback = function() {
	...
	test_feedback_text = '根据您的回答模式，我们认为您正在将此任务当作定向记忆任务来执行。请记住<strong>这是一个定向遗忘任务</strong>。</p>'+
						 '<p class = block-text>当您看到提示词TOP时，您应该<strong>忘记顶部字母</strong>并<strong>记住底部字母</strong>。</p>'+
						 '<p class = block-text>当您看到提示词BOT时，您应该<strong>忘记底部字母</strong>并<strong>记住顶部字母</strong>。</p>'+
						 '<p class = block-text>如果探测字母<strong>在记忆集合中</strong>，请按<strong>左</strong>箭头键；如果<strong>不在记忆集合中</strong>，请按<strong>右</strong>箭头键。</p>'+
						 '<p class = block-text>按回车键继续。'		
	} else {
	test_feedback_text = '按<strong>回车键</strong>继续'
	}
...
var test_img_block1 = {
	...
	stimulus: '<div class = instructBox><p class = block-text>这就是一个试验的样子。字母A、B和C在上方部分，而字母D、E和F在下方部分。这些字母消失后，会出现一个提示词。如果提示词是<strong>TOP</strong>，那么您应该<strong>忘记字母A、B和C</strong>并记住D、E和F。如果提示词是<strong>BOT</strong>，那么您应该<strong>忘记D、E和F</strong>并记住A、B和C。按<strong>回车键</strong>继续。</div>'+
...
var test_img_block2 = {
	type: 'poldrack-single-stim',
	stimulus: '<div class = centerbox><p class = center-block-text>我们将为您展示1个示例。按<strong>回车键</strong>开始。</p></div>',
	is_html: true,
	choices: [13],
	data: {
		trial_id: "instruction_images"
...
var feedback_instruct_text =
	'欢迎参加实验。这个任务大约需要20分钟。按<strong>回车键</strong>开始。'
...
var instructions_block = {
	...
	pages: [
		'<div class = centerbox><p class = block-text>在这个实验中，每次试验您将看到6个字母。您必须记住所有6个字母。</p><p class = block-text>6个字母呈现后，会有一个短暂的延迟。然后您会看到一个提示词，要么是<strong>TOP</strong>要么是<strong>BOT</strong>。这将指示您<strong>忘记</strong>位于屏幕顶部或底部（分别对应）的3个字母。</p><p class = block-text>您必须记住的剩余三个字母称为您的<strong>记忆集合</strong>。您应该记住这三个字母，同时忘记另外三个。</p><p class = block-text>然后您会看到一个单独的字母。如果它在记忆集合中，请按<strong>左</strong>箭头键；如果它不在记忆集合中，请按<strong>右</strong>箭头键。</p><p class = block-text>请确保在继续之前理解这些指令。结束指令后，您将看到一个示例试验。</p></div>',
	],
	allow_keys: false,
	...
	loop_function: function(data) {
		...
		if (sumInstructTime <= instructTimeThresh * 1000) {
			feedback_instruct_text =
				'您阅读指令过快。请仔细阅读并确保您理解指令。按<strong>回车键</strong>继续。'
			return true
...
var start_practice_block = {
	...
	pages: [
		'<div class = centerbox><p class = block-text>如您所见，屏幕顶部有三个字母，屏幕底部有三个字母。延迟后，提示词（TOP或BOT）告诉您是否要分别<strong>忘记</strong>屏幕顶部或底部的三个字母。其他三个字母是您的记忆集合。</p><p class = block-text>提示词后，会显示一个字母，如果它在记忆集合中，请按<strong>左</strong>箭头键；如果它不在记忆集合中，请按<strong>右</strong>箭头键。</p><p class = block-text>现在我们将开始一些练习试验。</p></div>',
	],
	allow_keys: false,
	show_clickable_nav: true,
	timing_post_trial: 1000
...
var start_test_block = {
	...
	text: '<div class = centerbox><p class = block-text>现在我们将开始测试。按<strong>回车键</strong>开始。</p></div>',
	cont_key: [13],
	timing_post_trial: 1000,
...
var intro_test_block = {
	...
	text: '<div class = centerbox><p class = block-text>现在我们将开始正式实验。在这些试验中，您将不再得到反馈。</p><p class = block-text>记住，提示词（TOP或BOT）告诉您要<strong>忘记</strong>哪些字母。试验结束时，如果呈现的字母在记忆集合中，请按<strong>左</strong>箭头键；如果它不在记忆集合中，请按<strong>右</strong>箭头键。</p><p class = block-text>按<strong>回车键</strong>开始实验。</p></div>',
	cont_key: [13],
	timing_post_trial: 1000,
	on_finish: resetTrial,
};
...
var practice_probe_block = {
	...
	correct_text: '<div class = bottombox><div style="color:green"; style="color:green"; class = center-text>正确！</div></div>',
	incorrect_text: '<div class = bottombox><div style="color:red"; style="color:red"; class = center-text>错误</div></div>',
