...
var post_task_block = {
   ...
   questions: ['<p class = center-block-text style = "font-size: 20px">请总结您在此任务中被要求做什么。</p>',
...
var feedback_instruct_text =
  '欢迎参加实验。此实验将需要少于10分钟时间。按<strong>回车键</strong>开始。'
...
var instructions_block = {
  ...
  pages: [
'<div class = centerbox><p class = block-text>在这个测试中，您需要尝试记住屏幕上依次出现的数字序列。在每个试验结束时，请按照数字出现的顺序，将所有数字输入到数字键盘中。请尽力记住这些数字，但不要写下来或使用其他外部工具来帮助您记忆。</p><p class = block-text>指导结束后试验将开始。</p></div>'
 ],
  allow_keys: false,
  ...
  loop_function: function(data) {
    ...
    if (sumInstructTime <= instructTimeThresh * 1000) {
      feedback_instruct_text =
        '阅读指导过快。请花时间确保您理解指导内容。按<strong>回车键</strong>继续。'
      return true
...
var start_reverse_block = {
  ...
  text: '<div class = centerbox><p class = block-text>在接下来的试验中，不要按照您刚看到的序列报告，而是报告该序列的<strong>倒序</strong>。因此，最后一个项目应该在您回答中排第一，倒数第二个应该排第二，依此类推...</p><p class = block-text>按<strong>回车键</strong>开始。</p></div>',
  cont_key: [13],
  on_finish: function() {
  	errors = 0
    num_digits = 3
