...
var getStim = function() {
  ...
  var stim = "<div class = centerbox id='container'><p class = center-block-text>请选择您更喜欢的选项，按 <strong>'q'</strong> 选择左侧，按 <strong>'p'</strong> 选择右侧：</p><div class='table'><div class='row'><div id = 'option'><center><font color='green'>￥" + left_amt + "<br>" + left_del + "</font></center></div><div id = 'option'><center><font color='green'>￥" + right_amt + "<br>" + right_del + "</font></center></div></div></div></div>"
  return stim
}
...
var bonus_list = []
var delays = jsPsych.randomization.shuffle(['1 天', '1 周', '1 个月', '6 个月', '1 年',
  '5 年', '25 年'
])
...
var feedback_instruct_text =
  '欢迎参加实验。这个任务大约需要 5 分钟。按 <strong>Enter</strong> 开始。'
...
var instructions_block = {
  ...
  pages: [
    '<div class = centerbox><p class = block-text>在这个实验中，您将面对两个不同金额的选择。这些金额将在不同的时间点提供。您的任务是通过按 <strong>"q"</strong> 选择左侧选项，按 <strong>"p"</strong> 选择右侧选项来表示您的偏好。</p><p class = block-text>您应该表示您的<strong>真实</strong>偏好，因为在实验结束时将随机选择一个试验，您将根据您选择的选项获得相应的奖励。我们将在您结束说明后开始。</p></div>',
  ],
  allow_keys: false,
  data: {
    trial_id: 'instruction'
  ...
  loop_function: function(data) {
    ...
    if (sumInstructTime <= instructTimeThresh * 1000) {
      feedback_instruct_text =
        '读取说明太快了。请花时间仔细阅读并确保您理解说明。按 <strong>Enter</strong> 继续。'
      return true
    } else if (sumInstructTime > instructTimeThresh * 1000) {
      feedback_instruct_text =
        '说明阅读完成。按 <strong>Enter</strong> 继续。'
      return false
    }
  }
}
...
var update_mag_block = {
  ...
  timing_post_trial: 0,
  on_finish: function() {
    delays = jsPsych.randomization.shuffle(['1 天', '1 周', '1 个月', '6 个月', '1 年',
      '5 年', '25 年'
    ])
  }
}
...
var end_block = {
  ...
  text: '<div class = centerbox><p class = center-block-text>感谢您完成这个任务！</p><p class = center-block-text>按 <strong>Enter</strong> 继续。</p></div>',
  cont_key: [13],
  timing_post_trial: 0,
