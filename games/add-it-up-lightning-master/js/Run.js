...
Game.Run.prototype = {
  ...
  quitGame: function (pointer) {
      ...
      this.game.time.events.add(Phaser.Timer.SECOND, function () {
        endText = this.game.add.text(this.game.width/2, 200, '完成！', {font:'96px Arial', fill:'#FFFFFF', align:'center'});
        endText.anchor.x = 0.5
        finalPoints = this.game.add.text(this.game.width/2, 400, '你获得了 ' + this.points + ' 个金币', {font:'76px Arial', fill:'#FFFFFF', align:'center'});
