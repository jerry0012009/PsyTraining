...
var feedback_instruct_text =
	'欢迎来到实验。此实验将花费不到20分钟。按<strong>回车键</strong>开始。'
...
var instructions_block = {
	...
	pages: [
		'<div class = centerbox><p class = block-text>在这个实验中，你将在屏幕右侧看到一个白色形状，在屏幕左侧看到一个绿色形状。如果它们是相同的形状，你的任务是按"M"键，如果它们不同，则按"Z"键。</p><p class = block-text>在某些试验中，左侧还会显示一个红色形状。你应该忽略红色形状——你的任务只是根据白色和绿色形状是否相同来做出反应。</p><p class = block-text>在你完成说明后，我们将开始练习。</p></div>'
	],
	allow_keys: false,
	...
	loop_function: function(data) {
		...
		if (sumInstructTime <= instructTimeThresh * 1000) {
			feedback_instruct_text =
				'阅读说明太快了。请慢慢来，确保你理解了说明。按<strong>回车键</strong>继续。'
			return true
...
var end_block = {
	...
	timing_response: 180000,
	text: '<div class = centerbox><p class = center-block-text>感谢完成此任务！</p><p class = center-block-text>按<strong>回车键</strong>继续。</p></div>',
	cont_key: [13],
	timing_post_trial: 0,
...
var start_test_block = {
	...
	timing_response: 180000,
	text: '<div class = centerbox><p class = center-block-text>我们现在将开始正式测试。请像练习时一样准确回应。整个测试期间会有三次短暂休息。</p><p class = center-block-text>按<strong>回车键</strong>开始测试。</p></div>',
	cont_key: [13],
	timing_post_trial: 1000,
	on_finish: function() {
		current_trial = 0
...
var rest_block = {
	...
	timing_response: 180000,
	text: '<div class = centerbox><p class = center-block-text>稍作休息！</p><p class = center-block-text>按<strong>回车键</strong>继续测试。</p></div>',
	cont_key: [13],
	timing_post_trial: 1000
};
...
var practice_block = {
	...
	timeout_message: '<div class = fb_box><div class = center-text><font size = 20>请回应快一点！</font></div></div>',
	timing_response: 2000,
	timing_feedback: 500,
	show_stim_with_feedback: true,
	timing_post_trial: 0,
	prompt: '<div class = centerbox><p class = block-text>如果白色和绿色形状相同，请按"M"键。否则按"Z"键。</p></div>.'
}
