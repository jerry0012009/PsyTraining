...
var test_intro_block = {
	type: 'poldrack-text',
	text: '<div class = centerbox><p class = center-block-text>现在开始测试。请按 <strong>回车键</strong> 开始。</p></div>',
	cont_key: [13],
	data: {
		trial_id: "intro",
		exp_stage: "test"
...
var end_block = {
	type: 'poldrack-text',
	text: '<div class = centerbox><p class = center-block-text>感谢您完成这个任务！</p><p class = center-block-text>请按 <strong>回车键</strong> 继续。</p></div>',
	cont_key: [13],
	data: {
		trial_id: "end",
...
var feedback_instruct_text =
	'欢迎参加实验。本实验大约需要 15 分钟。请按 <strong>回车键</strong> 开始。'
...
var instructions_block = {
	...
	pages: [
		'<div class = centerbox><p class = block-text>在这个实验中，您会看到由五个箭头和横线组成的图案，指向左边或右边（例如 &larr; &larr; &larr; &larr; &larr;，或 &mdash; &mdash; &rarr; &mdash; &mdash;），它们会随机出现在屏幕的上方或下方。</p><p class = block-text>您的任务是判断中间箭头的方向，并按相应的方向键。</p></div>',
		'<div class = centerbox><p class = block-text>在箭头和横线出现之前，屏幕上的某个地方偶尔会出现一个 * 号。</p><p class = block-text>无论 * 号是否出现或出现在哪里，重要的是您要尽可能快速准确地按下与中心箭头方向对应的方向键。</p><p class = block-text>说明结束后，我们将开始练习。在练习过程中，您会收到关于您的回答是否正确的反馈。在实验的其余部分您不会收到反馈。</p></div>'
	],
	allow_keys: false,
	data: {
		trial_id: 'instruction'
	...
	loop_function: function(data) {
		...
		if (sumInstructTime <= instructTimeThresh * 1000) {
			feedback_instruct_text =
				'您阅读说明过快。请仔细阅读并确保您理解了说明。请按 <strong>回车键</strong> 继续。'
			return true
		} else if (sumInstructTime > instructTimeThresh * 1000) {
			feedback_instruct_text = '说明已完成。请按 <strong>回车键</strong> 继续。'
			return false
		}
	}
}
...
var rest_block = {
	type: 'poldrack-text',
	text: '<div class = centerbox><p class = block-text>休息一下！请按任意键继续。</p></div>',
	timing_response: 180000,
	data: {
		trial_id: "rest block"
	},
...
for (i = 0; i < block.data.length; i++) {
	...
	var attention_network_task_practice_trial = {
		...
		timeout_message: '<div class = centerbox><div class = center-text>请反应更快！</div></div>',
		choices: choices,
		data: block.data[i],
