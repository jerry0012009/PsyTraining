...
var feedback_instruct_text =
  '欢迎来到实验。这个实验大约需要8分钟。按 <strong>回车键</strong> 开始。'
...
var instructions_block = {
  ...
  pages: [
    '<div class = centerbox><p class = block-text>在这个实验中，你将看到由较小字母组成的蓝色或黑色字母，如下图所示。所有较小的字母总是相同的字母。</p><div class = instructionImgBox><img src = "images/blue_s_of_o.png" height = 200 width = 200></img></div></div>',
    '<div class = centerbox><p class = block-text>你的任务是根据颜色判断较大或较小的字母是"H"还是"S"。如果字母是' +
    task_colors[0] + '色，请判断较大的字母是"H"还是"S"。如果字母是' +
    task_colors[1] +
    '色，请判断较小的字母是"H"还是"S"。</p><p class = block-text>使用"H"或"S"键来表示字母。</p></div>',
    '<div class = centerbox><p class = block-text>例如，对于下面的字母，你应该按"S"键，因为它是' +
    task_colors[1] +
    '色，这意味着你应该根据较小的形状做出反应。如果形状是' +
    task_colors[0] +
    '色，你应该按"H"键。</p><div class = instructionImgBox><img src = "images/' +
  ...
  loop_function: function(data) {
    ...
    if (sumInstructTime <= instructTimeThresh * 1000) {
      feedback_instruct_text =
        '阅读指导说明过快。请花时间确保你理解了指导说明。按 <strong>回车键</strong> 继续。'
      return true
...
var start_practice_block = {
  ...
  text: '<div class = centerbox><p class = center-block-text>我们将从一些练习开始。在练习中，你会得到关于是否回答正确的反馈。在实验的其余部分中，你不会得到反馈。</p><p class = center-block-text>按 <strong>回车键</strong> 开始。</p></div>',
  cont_key: [13],
  timing_post_trial: 1000
};
...
var start_test_block = {
  ...
  text: '<div class = centerbox><p class = center-block-text>现在我们将开始测试。记住，如果字母是' +
    task_colors[0] + '色，请判断较大的字母是"H"还是"S"。如果字母是' +
    task_colors[1] +
    '色，请判断较小的字母是"H"还是"S"。</p><p class = center-block-text>按 <strong>回车键</strong> 开始。</p></div>',
  cont_key: [13],
  timing_post_trial: 1000,
  on_finish: function() {
  	current_trial = 0
...
var practice_block = {
  ...
  timeout_message: '<div class = centerbox><div class = center-text>请更快回应！</div></div>',
  choices: choices,
