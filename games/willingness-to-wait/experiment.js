...
var post_task_block = {
   ...
   questions: ['<p class = center-block-text style = "font-size: 20px">请简述一下您在此任务中被要求做的事情。</p>',
              '<p class = center-block-text style = "font-size: 20px">您对此任务有什么评论或意见吗？</p>'],
   rows: [15, 15],
   columns: [60,60]
};
...
var welcome_block = {
  ...
  text: '<div class = centerbox><p class = center-block-text>欢迎参与此实验。此任务大约需要11分钟。按<strong>回车键</strong>开始。</p></div>',
  cont_key: [13],
  timing_response: 180000,
  timing_post_trial: 0
};
  ...
  loop_function: function(data) {
    ...
    if (sumInstructTime <= instructTimeThresh * 1000) {
      feedback_instruct_text =
        '您读取指令的速度过快。请您花时间仔细阅读，确保理解指令内容。按<strong>回车键</strong>继续。'
      return true
