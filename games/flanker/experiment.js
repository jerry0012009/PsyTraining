...
var post_task_block = {
   ...
   questions: ['<p class = center-block-text style = "font-size: 20px">请总结一下在这项任务中你被要求做什么。</p>',
              '<p class = center-block-text style = "font-size: 20px">你对这项任务有什么意见吗？</p>'],
   rows: [15, 15],
   columns: [60,60]
};
/* define static blocks */
var feedback_instruct_text =
	'欢迎来到这个实验。按 <strong>回车键</strong> 开始。'
...
var instructions_block = {
	...
	pages: [
		"<div class = centerbox><p class = block-text>在这个实验中，你将看到由字母 f 和 h 组成的五个字母串。例如，你可能会看到 'fffff' 或 'hhfhh'。你的任务是按下与 <strong>中间</strong> 字母对应的按键。所以如果你看到 'ffhff'，你需要按 'h' 键。</p><p class = block-text>每次回应后，你会收到关于是否正确的反馈。我们将从一个简短的练习开始。</p></div>"
	],
	allow_keys: false,
	data: {
		trial_id: "instruction"
	...
	loop_function: function(data) {
		...
		if (sumInstructTime <= instructTimeThresh * 1000) {
			feedback_instruct_text =
				'阅读指示过快。请慢慢阅读并确保理解指示。按 <strong>回车键</strong> 继续。'
			return true
		} else if (sumInstructTime > instructTimeThresh * 1000) {
			feedback_instruct_text = '指示完成。按 <strong>回车键</strong> 继续。'
			return false
		}
	}
}
...
var end_block = {
	...
	text: '<div class = centerbox><p class = center-block-text>感谢完成这项任务！</p><p class = center-block-text>按 <strong>回车键</strong> 继续。</p></div>',
	cont_key: [13],
	timing_post_trial: 0
};
...
for (i = 0; i < practice_len; i++) {
	...
	var practice_block = {
		...
		timeout_message: '<div class = centerbox><div class = flanker-text>请更快回应</div></div>',
		choices: [70, 72],
