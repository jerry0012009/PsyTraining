...
response_grid +=
  '<button class = clear_button id = "ClearButton" onclick = "clearResponse()">清除</button>' +
  '<button class = submit_button id = "SubmitButton">提交答案</button></div>'
setStims()
...
var feedback_instruct_text =
  '欢迎来到实验。这个实验将花费不到10分钟的时间。按<strong>Enter</strong>键开始。'
...
var instructions_block = {
  ...
  pages: [
    '<div class = centerbox><p class = block-text>在这个测试中，你将看到一个方格网格，其中的方格会依次闪烁红色。你需要记住方格闪烁红色的顺序。在每次试验结束时，按照你看到的顺序在网格中输入序列。请尽力记住序列，但不要写下来或使用任何其他外部工具来帮助记忆。</p><p class = block-text></p><p class = block-text>指导结束后试验将开始。</p></div>'
  ],
  allow_keys: false,
  ...
  loop_function: function(data) {
    ...
    if (sumInstructTime <= instructTimeThresh * 1000) {
      feedback_instruct_text =
        '阅读指导过快。请花时间确保理解指导内容。按<strong>Enter</strong>键继续。'
      return true
...
var end_block = {
  ...
  timing_response: 180000,
  text: '<div class = centerbox><p class = center-block-text>此任务已完成。</p><p class = center-block-text>按<strong>Enter</strong>键继续。</p></div>',
  cont_key: [13],
  timing_post_trial: 0
};
...
var start_reverse_block = {
  ...
  timing_response: 180000,
  text: '<div class = centerbox><p class = block-text>在接下来的试验中，不要报告你刚看到的序列，而是报告该序列的<strong>倒序</strong>。因此，最后一个项目应该是你回答中的第一个，倒数第二个应该是你回答中的第二个，等等...</p><p class = block-text>按<strong>Enter</strong>键开始。</p></div>',
  cont_key: [13],
  on_finish: function() {
  	errors = 0
    num_spaces = 3
...
var forward_response_block = {
  ...
  on_finish: function() {
    ...
    if (arraysEqual(response, curr_seq)) {
      num_spaces += 1
      feedback = '<span style="color:green">正确！</span>'
      stims = setStims()
      correct = true
    } else {
      errors += 1
      ...
      feedback = '<span style="color:red">错误</span>'
      stims = setStims()
    }
    jsPsych.data.addDataToLastTrial({
      correct: correct
