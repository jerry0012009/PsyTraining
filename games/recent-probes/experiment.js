...
var instructions_block = {
	...
	pages: [
		'<div class = centerbox><p class = block-text>在本实验中，每次试验都会向您呈现6个字母，称为您的记忆集。您必须记住所有6个字母。</p><p class = block-text>呈现6个字母后，会有一个短暂的延迟，然后向您呈现一个字母。如果它在记忆集中，请按<strong>左</strong>箭头键，如果不在记忆集中，请按<strong>右</strong>箭头键。</p><p class = block-text>练习将在您完成说明后开始。</p></div>'
	],
	allow_keys: false,
	...
	loop_function: function(data) {
		...
		if (sumInstructTime <= instructTimeThresh * 1000) {
			feedback_instruct_text =
				'阅读指导说明过快。请慢慢来，确保您理解了指导说明。按<strong>回车键</strong>继续。'
			return true
...
var start_test_block = {
	...
	text: '<div class = centerbox><p class = block-text>我们现在将开始另一次测试运行。按<strong>回车键</strong>开始。</p></div>',
	cont_key: [13],
	timing_post_trial: 1000,
...
var intro_test_block = {
	...
	text: '<div class = centerbox><p class = block-text>我们现在将开始正式实验。在这些试验中，您将不再获得反馈。</p><p class = block-text>记住，在试验结束时，如果呈现的字母在记忆集中，请按<strong>左</strong>箭头键，如果不在记忆集中，请按<strong>右</strong>箭头键。</p><p class = block-text>按<strong>回车键</strong>开始实验。</p></div>',
	cont_key: [13],
	timing_post_trial: 1000,
	on_finish: resetTrial,
};
...
var practice_probe_block = {
	...
	timeout_message: '<div class = bottombox><div class = center-text>未检测到响应</div></div>',
	timing_stim: 2000,
